...
def test_convert_to_scen_units():
    var_start_units_scen_units_conv_factor = (
        ...
        ("Emissions|N2O","kt N2O/yr", "Mt N2ON/yr", (2*14) / (1000*(2*14 + 16)), None),
        ...
        ("Emissions|NOx","Mt NOx/yr", "Mt N/yr", 14 / (14 + 2*16), "NOx_conversions"),
    ...
    for variable, _, target_unit, conv_factor, _ in var_start_units_scen_units_conv_factor:
